		  ...
		  <div id="flex" align="center">
		     <a4j:outputPanel id="flexPanel" > 
			   ...
			   <f:verbatim>
			    ...
			    <% 
			    	String s[]= request.getParameterValues("viewer_flash");
				    if(s!=null && s[0]=="true"){
    			 %>
			      ...
			      <object id="flexMovie" type="application/x-shockwave-flash" data="swf/o3dpacswebflex.swf" align="top">
				    ...
				    %> 			     
			      <object id="expriviaMovie" data="viewer-o3pacs-csi/index.html"
			      	...
			      	serviceURL= "http://127.0.0.1:7080/o3-dpacs-wado"/>'
			      > 
				      <param name="allowScriptAccess" value="sameDomain" />
			      </object>
			      ...
			      <script	type="text/javascript" language="javascript">
		           function getWindowHeight(){
					...
					var viewer_flash = <%=request.getParameterValues("viewer_flash") %>;
				    if(viewer_flash!=null && viewer_flash=="true")
						{
					document.getElementById("flexMovie").style.height=(getWindowHeight()-160)+"px";
					document.getElementById("flexMovie").style.width=(getWindowWidth()/2-60)+"px";	
						}
					else
						{
						
					document.getElementById("expriviaMovie").style.height=(getWindowHeight()-160)+"px";
					document.getElementById("expriviaMovie").style.width=(getWindowWidth()-60)+"px";	
						}
