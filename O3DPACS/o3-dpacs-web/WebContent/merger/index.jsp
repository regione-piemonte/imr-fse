...
<f:view locale="#{sessionScope.locale}"
	...
	<title><h:outputText value="#{msg.merger}" /></title>
	...
	<div class="backAction" style="text-align: left;"></div>
	  <a4j:form>
		<div align="center">
		     ...
		     <a4j:outputPanel id="flexPanel" > 
			   ...
			   <f:verbatim>
			    ...
			    <span display="block" style="height: 100%; margin: 0; padding: 0;">
			      <object id="flexMovie" type="application/x-shockwave-flash" data="swf/MergeTools.swf" align="top">
				    <param value="swf/MergeTools.swf" name="movie" />
