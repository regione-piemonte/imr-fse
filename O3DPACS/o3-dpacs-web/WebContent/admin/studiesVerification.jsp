...
<f:view locale="#{sessionScope.locale}"
	...
	<title><h:outputText value="Studies Verification Tools" /></title>
	<script src="swf/js/swfobject.js" type="text/javascript">
		swfobject.embedSWF("swf/stvAdmin.swf", "flex", "1300", "500", "9.0.0");
	</script>
		     ...
		     <a4j:outputPanel id="flexPanel" > 
			   ...
			   <f:verbatim>
			    ...
			    <span display="block" style="height: 100%; margin: 0; padding: 0;">
			      <object id="flexMovie" type="application/x-shockwave-flash" data="swf/stvAdmin.swf" align="top">
				    <param value="swf/stvAdmin.swf" name="movie" />
