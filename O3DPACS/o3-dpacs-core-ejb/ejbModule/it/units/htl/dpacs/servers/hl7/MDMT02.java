...
public class MDMT02 extends HL7Dealer {
	
	
	protected String structASR;
	private String management;
	private MoveStudyHistory moveSH;
	
	public MDMT02(HL7Server hl7) {
		super(hl7);
	...
	protected void run() throws Exception{
		...
		if(MDM_MGMT_STUDYMOVE.equals(management)){
			log.info("Received MDM^T02 structASR = " + structASR + " AccessionNumber" + moveSH.getAccessionnumber() );
