...
public class RichiestaScarico{
	...
	private Timestamp datacreazionepac;
	
	
	
	
	
	public Timestamp getDatacreazionepac() {
		return datacreazionepac;
	}
	public void setDatacreazionepac(Timestamp datacreazionepac) {
		this.datacreazionepac = datacreazionepac;
	}
