...
public class LogUtil {
	public static final String APPLICATION_CODE = "ScaricoStudiWSBean";
	...
	private static String formatMessage(String message, Object... args) {
		try {
			...
			return message + " - args: " + Arrays.toString(args) + " - formatMessage warn: " + e.getMessage();
		}
	}
	 ...
	 * 
	 * @param obj oggetto con annotazione XmlType da convertire in xml per il
	 *            logging
