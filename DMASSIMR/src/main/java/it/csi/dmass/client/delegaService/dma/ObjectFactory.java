 ...
 * generated in the it.csi.dmass.client.delegaService.dma package. 
...
public class ObjectFactory {
    ...
    private final static QName _CittadinoDelegante_QNAME = new QName("http://dma.csi.it/", "cittadinoDelegante");
    private final static QName _CittadinoDelegato_QNAME = new QName("http://dma.csi.it/", "cittadinoDelegato");
    ...
    private final static QName _Deleganti_QNAME = new QName("http://dma.csi.it/", "deleganti");
    private final static QName _Errori_QNAME = new QName("http://dma.csi.it/", "errori");
    private final static QName _GetDelegantiIN_QNAME = new QName("http://dma.csi.it/", "getDelegantiIN");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.csi.dmass.client.delegaService.dma
     * 
     */
    ...
    /**
     * Create an instance of {@link GetDeleganti2IN }
     * 
     */
    public GetDeleganti2IN createGetDeleganti2IN() {
        return new GetDeleganti2IN();
    }
    ...
    /**
     * Create an instance of {@link GetDelegantiIN }
     * 
     */
    public GetDelegantiIN createGetDelegantiIN() {
        return new GetDelegantiIN();
    }
    ...
    /**
     * Create an instance of {@link CittadinoDelegante }
     * 
     */
    public CittadinoDelegante createCittadinoDelegante() {
        return new CittadinoDelegante();
    }

    /**
     * Create an instance of {@link CittadinoDelega }
     * 
     */
    public CittadinoDelega createCittadinoDelega() {
        return new CittadinoDelega();
    }

    /**
     * Create an instance of {@link CittadinoDelegato }
     * 
     */
    public CittadinoDelegato createCittadinoDelegato() {
        return new CittadinoDelegato();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dma.csi.it/", name = "cittadinoDelegante")
    public JAXBElement<Paziente> createCittadinoDelegante(Paziente value) {
        return new JAXBElement<Paziente>(_CittadinoDelegante_QNAME, Paziente.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dma.csi.it/", name = "cittadinoDelegato")
    public JAXBElement<Paziente> createCittadinoDelegato(Paziente value) {
        return new JAXBElement<Paziente>(_CittadinoDelegato_QNAME, Paziente.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dma.csi.it/", name = "deleganti")
    public JAXBElement<Paziente> createDeleganti(Paziente value) {
        return new JAXBElement<Paziente>(_Deleganti_QNAME, Paziente.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetDelegantiIN }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://dma.csi.it/", name = "getDelegantiIN")
    public JAXBElement<GetDelegantiIN> createGetDelegantiIN(GetDelegantiIN value) {
        return new JAXBElement<GetDelegantiIN>(_GetDelegantiIN_QNAME, GetDelegantiIN.class, null, value);
    }
