...
public class ScaricoPacchettoCitAutDto {
	...
	public String getCodDocumentoIlec() {
		return codDocumentoIlec;
	}
	public void setCodDocumentoIlec(String codDocumentoIlec) {
		this.codDocumentoIlec = codDocumentoIlec;
	}
