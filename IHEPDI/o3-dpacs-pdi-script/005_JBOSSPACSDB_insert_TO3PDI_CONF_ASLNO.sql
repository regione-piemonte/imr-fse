...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/NO/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/NO/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/NO/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>208</nome>
	  <endpoint>http://10.138.137.1:11710</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/NO/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/NO/Conf/assets/ASLNO/HTMLTransformation.xsl</xslt>  
	  <css>ASLNO/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>ASLNO/utility.js</js>
