...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/AOUNO/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/AOUNO/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/AOUNO/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>905</nome>
	  <endpoint>http://10.138.136.237:10610</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/AOUNO/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/AOUNO/Conf/assets/AOUNO/HTMLTransformation.xsl</xslt>  
	  <css>AOUNO/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>AOUNO/utility.js</js>
      <commandMove>cp ${fileToMove} ${dist}</commandMove>
	  <viewer>/fs-dmass/ConfAll/AOUNO/Conf/viewer/viewer_ASONO.zip</viewer>
	</asl>
</configurazioni>','1');
