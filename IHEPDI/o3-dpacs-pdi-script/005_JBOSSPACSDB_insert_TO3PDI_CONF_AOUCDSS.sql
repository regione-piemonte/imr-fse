...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/AOUCDSS/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/AOUCDSS/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/AOUCDSS/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>909</nome>
	  <endpoint>http://10.138.137.38:11810</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/AOUCDSS/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/AOUCDSS/Conf/assets/AOUCDSS/HTMLTransformation.xsl</xslt>  
	  <css>AOUCDSS/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>AOUCDSS/utility.js</js>
