...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/AOCN/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/AOCN/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/AOCN/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>906</nome>
	  <endpoint>http://10.138.137.2:11010</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/AOCN/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/AOCN/Conf/assets/AOCN/HTMLTransformation.xsl</xslt>  
	  <css>AOCN/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>AOCN/utility.js</js>
