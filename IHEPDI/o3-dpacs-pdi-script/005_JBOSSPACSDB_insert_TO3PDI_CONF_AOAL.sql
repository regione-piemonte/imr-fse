...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/AOAL/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/AOAL/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/AOAL/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>907</nome>
	  <endpoint>http://10.138.137.10:11510</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/AOAL/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/AOAL/Conf/assets/AOAL/HTMLTransformation.xsl</xslt>  
	  <css>AOAL/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>AOAL/utility.js</js>
