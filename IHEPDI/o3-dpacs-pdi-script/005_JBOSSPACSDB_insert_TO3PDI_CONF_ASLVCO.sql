...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/VCO/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/VCO/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/VCO/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>209</nome>
	  <endpoint>http://10.138.137.253:10310</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/VCO/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/VCO/Conf/assets/ASLVCO/HTMLTransformation.xsl</xslt>  
	  <css>ASLVCO/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>ASLVCO/utility.js</js>
