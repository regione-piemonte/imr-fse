...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/CN2/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/CN2/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/CN2/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>211</nome>
	  <endpoint>http://10.138.137.14:10100</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/CN2/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/CN2/Conf/assets/ASLCN2/HTMLTransformation.xsl</xslt>  
	  <css>ASLCN2/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>ASLCN2/utility.js</js>
