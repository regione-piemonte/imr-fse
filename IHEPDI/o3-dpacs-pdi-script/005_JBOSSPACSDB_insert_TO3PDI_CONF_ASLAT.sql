...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/AT/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/AT/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/AT/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>212</nome>
	  <endpoint>http://10.138.137.15:10510</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/AT/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/AT/Conf/assets/ASLAT/HTMLTransformation.xsl</xslt>  
	  <css>ASLAT/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>ASLAT/utility.js</js>
