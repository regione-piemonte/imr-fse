...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/VC/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/VC/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/VC/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>206</nome>
	  <endpoint>http://10.138.137.252:10410</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/VC/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/VC/Conf/assets/ASLVC/HTMLTransformation.xsl</xslt>  
	  <css>ASLVC/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>ASLVC/utility.js</js>
