...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/BI/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/BI/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/BI/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>207</nome>
	  <endpoint>http://10.138.137.25:11310</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/BI/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/BI/Conf/assets/ASLBI/HTMLTransformation.xsl</xslt>  
	  <css>ASLBI/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>ASLBI/utility.js</js>
