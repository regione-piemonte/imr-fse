...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/AOUSLU/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/AOUSLU/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/AOUSLU/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>904</nome>
	  <endpoint>http://10.138.137.35:11410</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/AOUSLU/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/AOUSLU/Conf/assets/AOUSLU/HTMLTransformation.xsl</xslt>  
	  <css>AOUSLU/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>AOUSLU/utility.js</js>
