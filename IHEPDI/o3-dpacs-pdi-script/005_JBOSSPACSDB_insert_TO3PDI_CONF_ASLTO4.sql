...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/TO4/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/TO4/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/TO4/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>204</nome>
	  <endpoint>http://10.138.137.21:10210</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/TO4/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/TO4/Conf/assets/ASLTO4/HTMLTransformation.xsl</xslt>  
	  <css>ASLTO4/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>ASLTO4/utility.js</js>
