...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Assets','/fs-dmass/ConfAll/AL/Conf/assets/','1');
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Workarea','/fs-dmass/ConfAll/AL/workarea/','1');
...
Insert into JBOSSPACSDB.TO3PDI_CONF (PARAMKEY,PARAMVALUE,ENABLED) values ('Readme','/fs-dmass/ConfAll/AL/Conf/README.txt','1');
...
<configurazioni>
	<asl id ="1">
	  <nome>213</nome>
	  <endpoint>http://10.138.137.11:11610</endpoint>
	  <nume_retry>3</nume_retry>
	  <time_lapse>10000</time_lapse>
	  <dist>/fs-dmass/ConfAll/AL/dist/</dist>	
	  <xslt>/fs-dmass/ConfAll/AL/Conf/assets/ASLAL/HTMLTransformation.xsl</xslt>  
	  <css>ASLAL/NONE.css</css>
	  <time_lapse_move>5000</time_lapse_move>
	  <js>ASLAL/utility.js</js>
